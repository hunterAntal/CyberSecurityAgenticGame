...
| Name | Contribution |
|------|-------------|
| Hunter Antal | WebSocket bridge, game flow, DefenderAgent, MonitoringScoringAgent, frontend |
| [Teammate — add name] | PhishingAttackAgent, BruteForceAgent, MalwarePropagationAgent, ML model training |

---

## Course Context

Built for **ESOF 5014 — Agile Software Development** as a group project demonstrating multi-agent systems, iterative development, and integration of ML models into a real-time application.
